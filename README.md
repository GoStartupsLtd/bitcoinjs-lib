...
- [Create (and broadcast via 3PBP) a Transaction with a SegWit P2WPKH input](checkEquihashhttps://github.com/BTCGPU/bitcoinjs-lib/blob/master/test/integration/transactions.spec.ts)
